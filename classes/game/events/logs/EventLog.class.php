...
abstract class EventLog {
	 ...
	 * init the log object
	 *
	 * @param integer $base_id      the id of the base the event takes place
	 * @param integer $event_type_id the type of the event log
	 *
	 * @return EventLog
	 */
	 ...
	 *
	 * @param array $resources array of resources and their ids
	 *
	 * @return void
	 */
	 ...
	 * log all players
	 *
	 * @param integer $event_log_id the id of the new log entry
	 *
	 * @return void
	 */
