...
class Events {
     ...
     *
     * @access public
     * @param int $eventid - id of event to be locked
     * @param string $process_hash - hash value of current process for later identification
     * @return bool
     */
     ...
     * @param string $process_hash - hash value of process to be checked
     ...
     * @access public
     * @param int $eventid     id of event
     * @param int $processhash the hash of the event entry to load - optional
     *
     ...
     *
     * @access public
     * @param string $key - specific key of loaded event
     ...
     *
     * @access public
     * @param array $data - array with all values which should be inserted into database
     ...
     *
     * @access public
     * @param int $eventid - id of event to be activated
     * @return bool
     */
     ...
     *
     * @access public
     * @param int $eventid - id of event to be deactivated
     * @return bool
     */
